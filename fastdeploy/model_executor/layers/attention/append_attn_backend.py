...
class AppendAttentionBackend(AttentionBackend):
    ...
    def init_attention_metadata(self, forward_meta: ForwardMeta):
        ...
        if compute_capability >= 70 and compute_capability < 80:
            ...
            if compatible_dtype == "float16":
                ...
                logger.info(f"Using fp16 for append attention computation on CC{compute_capability}")
    ...
    def forward_mixed(
        ...
        res = append_attention(
            ...
            getattr(layer, "cache_k_quant_scales", None),
            getattr(layer, "cache_v_quant_scales", None),
            getattr(layer, "cache_k_dequant_scales", None),
            getattr(layer, "cache_v_dequant_scales", None),
            getattr(layer, "cache_k_zp", None),
            getattr(layer, "cache_v_zp", None),
            layer.out_linear_shifts,
            layer.out_linear_smooths,
